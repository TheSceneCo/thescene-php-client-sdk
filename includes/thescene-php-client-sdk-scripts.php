...
function thescene_add_scripts(){
    wp_enqueue_style('thescene-php-client-sdk-style', plugins_url().'/thescene-php-client-sdk-master/css/thescene-php-client-sdk.css');
    wp_enqueue_script('thescene-php-client-sdk-scripts', plugins_url().'/thescene-php-client-sdk-master/js/thescene-php-client-sdk.js', array('jquery'));
}
